...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { metercount: @measurement.metercount, point: @measurement.point, testervalue: @measurement.testervalue }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { metercount: @measurement.metercount, point: @measurement.point, testervalue: @measurement.testervalue }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
