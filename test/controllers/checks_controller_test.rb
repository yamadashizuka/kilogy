...
class ChecksControllerTest < ActionController::TestCase
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post :create, check: { exterior: @check.exterior, stain: @check.stain, tone: @check.tone, weather_id: @check.weather_id }
    end
  ...
  test "should update check" do
    patch :update, id: @check, check: { exterior: @check.exterior, stain: @check.stain, tone: @check.tone, weather_id: @check.weather_id }
    assert_redirected_to check_path(assigns(:check))
  end
